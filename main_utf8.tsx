...
const CreateTaskDrawer: React.FC<CreateTaskDrawerProps> = ({ isOpen, onClose, task, initialProjectId }) => {
    ...
    // Debounced auto-save ΓÇö only fires when editing an existing task
    ...
    // Watchers ΓÇö each field triggers auto-save with the latest full payload
    useEffect(() => {
    ...
    return (
        ...
        >
                ...
                <div className="pb-20">
                    ...
                    <div className="flex flex-wrap gap-2 py-1 border-y border-gray-50 mt-1">
                        ...
                        >
                            ...
                            <span>{attachMutation.isPending ? 'UploadingΓÇª' : 'Attach'}</span>
                        </button>
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 flex justify-between items-center z-20">
                {task ? (
                    // ΓöÇΓöÇ Edit mode: auto-save status indicator ΓöÇΓöÇ
                    <>
                        <div className="flex items-center space-x-2 px-2">
                            {saveStatus === 'saving' && (
                                <>
                                    <Loader2 className="w-3.5 h-3.5 text-gray-400 animate-spin" />
                                    <span className="text-[11px] text-gray-400 font-medium">SavingΓÇª</span>
                                </>
                            )}
                            {saveStatus === 'saved' && (
                                <>
                    ...
                    // ΓöÇΓöÇ Create mode: Cancel + Create button ΓöÇΓöÇ
                    <>
                        ...
                        <div className="flex space-x-2">
                            ...
                            >
                                ...
                                {createMutation.isPending ? 'CreatingΓÇª' : 'Create'}
                            </button>
                        </div>
                    </>
                )}
