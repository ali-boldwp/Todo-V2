...
const register = async (req, res) => {
    try {
        ...
        // Generate Token
        const token = jsonwebtoken_1.default.sign({ userId: user._id, email: user.email, role: user.role, clientId: user.clientId }, process.env.JWT_SECRET || 'secret', { expiresIn: '1d' });
