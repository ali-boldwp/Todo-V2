...
export function ProjectTasksPage() {
  ...
  const projectTasks = useMemo(
    () => mockTasks.filter((task: any) => task.projectId === projectId),
    [projectId]
  );
                ...
                >
                  ...
                  {!isCollapsed && (
                    <div className="px-4 pb-4 space-y-2">
                      ...
                      {/* Add Task to Section */}
                      <button className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border-2 border-dashed border-slate-200 hover:border-indigo-300 hover:bg-indigo-50/30 text-slate-400 hover:text-indigo-600 transition-all group">
